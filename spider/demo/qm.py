...
# base_url = "http://www.shenbyj1.com/forum-52-93.html"   #gz
# base_url = "http://www.shenbyj1.com/forum-88-10.html"    #fwh
base_url = "http://www.shenbyj1.com/forum-2-120.html"
page_num=120
MAX_WAIT_TIME = 180
SAVE_PATH="data1/"
IMG_PATH='imgs/'
if __name__ == "__main__":
    ...
    imgs_cnt = 1
    while(True):
        # mm_lists = br.find_elements_by_xpath("//*[@id=\"moderate\"]/div/div/div[2]/div[1]/[@class=\"nex_forumtit\"]/a")
        mm_lists = br.find_elements_by_xpath("//*[@class=\"nex_forumtit_top\"]/a[1]")
        ...
        # break
            ...
            try:
                ...
                wchat = br.find_element_by_xpath("//*/tbody/tr[1]/td/div[2]/div/div/font/fieldset/font/p/span")
                print("finsh wchat")
                imgs = br.find_elements_by_xpath("//*/ignore_js_op/dl/dd/div/img")
                print("finsh imgs")
                detales = br.find_element_by_xpath("//*/tbody/tr[1]/td/div[2]/div/font/font/font/font/font/div[1]/table/tbody/tr")
            ...
            try:
                detales = br.find_element_by_xpath("//*/tbody/tr[1]/td/div[2]/div/font/font/font/font/font/div[1]/table/tbody/tr")
                story.append(Paragraph(detales.text, BODY))
                print(detales.text)
            except BaseException:
                print("not detales")
        ...
        #         print("download image fail.")
            ...
            try:
                text_lists = br.find_elements_by_xpath("//*[@class=\"viewinfo\"]/table/tbody/tr[1]/td/div[2]/div/div[1]/table/tbody/tr/td")
                for i in range(len(text_lists)):
                    story.append(Paragraph(text_lists[i].text, BODY))
                    print(text_lists[i].text    )
            except BaseException:
                print("get text fail.")
            doc.build(story)
            br.close()
        ...
        # # next_page.click()
        page_num = page_num + 1
        next_page_url = "http://www.shenbyj1.com/forum-2-%d.html"%page_num
        # # br = webdriver.Chrome()
